...
<div class="box box-default">
	<div class="box-header" >
		<div class="btn-group" id="links">
			<button id="manage" class="btn btn-primary">Manage Module</button>
			<button  class="btn btn-primary " data-toggle="modal" data-target="#addmodule"> <i class="fa fa-plus"></i> Add Module</button>
		</div>		
	</div>
	<div class="box-body">
...
<div class="modal modal-primary fade" id="addmodule" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog ">
		 <div class="modal-content">
				...
				<?php $this->load->view('module/add-module'); ?>
...
$(document).ready(function() {
	...
	function showModules(){
		...
		$('#module-view').fadeOut('slow', function(){
			$('#module-view').load('<?php echo base_url();?>manage-module', function(){
				// hide loader image
				$('#loader-image').hide(); 
